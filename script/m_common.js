...
let bt1 = document.getElementById('textMenu1');
let bt2 = document.getElementById('textMenu2');
let bt3 = document.getElementById('textMenu3');
let bt4 = document.getElementById('textMenu4');
let bt5 = document.getElementById('textMenu5');
...
let icon1 = document.getElementById('button1');
let icon2 = document.getElementById('button2');
let icon3 = document.getElementById('button3');
let icon4 = document.getElementById('button4');
let icon5 = document.getElementById('button5');
